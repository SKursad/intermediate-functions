...
// maar ook een manier moeten vinden om het geen dat je verzamelt ergens te bundelen.
// Op deze manier zul je ontdekken hoe je omgaat met scope.
...
const graduation2 = cumLaude([6, 4, 5]);
const graduation3 = cumLaude([8, 9 ,4 ,6 , 10]);

console.log(graduation);
console.log(graduation2);
console.log(graduation3);
...
// * Hoe zorgt ik ervoor dat ik alle waardes uit de array kan langslopen,
//   ook als de array wel 100 entries zou bevatten?
// Log het antwoord in de terminal.
...
// Schrijf een functie genaamd averageGrade, die een array van cijfers verwacht
// (zoals grades) en het gemiddelde cijfer teruggeeft. Gebruik hiervoor jouw antwoord van 2a.
...
const average1 = averageGrade([6, 4, 5])
const average2 = averageGrade([8, 9, 4, 6, 10])
...
// Zorg ervoor dat het gemiddelde cijfer dat wordt teruggegeven
// uit de functie netjes wordt afgerond op twee decimalen.
// Tip: Google is your best friend!

const roundOfAverage = averageGrade(grades);

console.log(roundOfAverage.toFixed(2));


/* Bonusopdracht: hoogste cijfer */

/* 3a: Script schrijven  */
// Schrijf een script die op basis van de grades array (hierboven)
// checkt wat het hoogst behaalde cijfer is. Je mag hier geen bestaande methoden voor gebruiken.
...
function highestGrades(arrayOfNumbers) {
    let count = 0;

    for (let i = 0; i < arrayOfNumbers.length; i++) {
        if (arrayOfNumbers[i] > count) {
...
const highestNumber = highestGrades(grades);
const highestNumber2 = highestGrades([6, 4, 5]);
const highestNumber3 = highestGrades([8, 9, 4, 6, 10]);
